...
class NavigationList extends Component {
    ...
    render() {
        const list = [{ title: "Cash Register", path: "/" }, { title: "Bills", path: "/bills" }, { title: "Products", path: "/products" },{ title: "Categories", path: "/categories" }, { title: "Users", path: "/users" }, { title: "Profil", path: "/profil" }]
        return (
